...
namespace xiaoNet
{
     ...
     *
     */
    class XIAONET_EXPORT Channel : NonCopyable
    {
    public:
        ...
        /**
         * @brief Set the Read Callback object
         *
        ...
        /**
         * @brief Set the Write Callback object
         *
         ...
         * callback would be called the socket can be written.
         */
